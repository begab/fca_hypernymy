...
\toprule
  ...
  \caption{Our submissions results: \texttt{offic}ial and those that can be
  \texttt{repr}o\texttt duced with the code in the project repo (with the 
  \textit{isFrequentHypernym} feature being turned off).}

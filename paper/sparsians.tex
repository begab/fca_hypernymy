...
categorized as meaning components or entities. Results were reported for each category 
...
In FCA terminology, a \emp{context} is
...
query cases we trained \emph{logistic regression} classifier, (one each for
concepts and entities) relying on the
...
% TODO acknowledge Kornai for useful comments (more negative samples) (elég a
% végsőben)

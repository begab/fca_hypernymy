  ...
  \begin{columns}[t]% the [t] option aligns the column's content at the top
    ...
    \begin{column}{\sepwid} \end{column}   % empty spacer column
            ...
            \item relation to hypernymy 
              \begin{itemize} 
                ...
                \item concept hierarchy from a text corpus with FCA \citep{Cimiano:2005}
                  % todo Tools.  Our submissions experiment with formal concept analysis tool by \citet{Endres:2010}
              \end{itemize}
          \end{itemize}
        \end{block}
     ...
     \begin{column}{\sepwid} \end{column}   % empty spacer column
       ...
       %%%%%%%%%%%%%%%%%%%%%%%%%%%%
       \begin{column}{\onecolwid} % második oszlop
         %%%%%%%%%%%%%%%%%%%%%%%%%%%%
